...
class ItemComplete extends Job implements ShouldQueue
{
    ...
    {
        $item = $this->item;
        $mailer->send('emails.itemcomplete', ['item' => $item], function ($message) use ($item) {
          $message->subject('Your wemockup item is complete!');
