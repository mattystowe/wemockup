...
class ItemCancelled extends Job implements ShouldQueue
{
     ...
     */
     ...
     {
         $item = $this->item;
         $mailer->send('emails.itemcancelled', ['item' => $item], function ($message) use ($item) {
           $message->subject('Your wemockup item has been cancelled.');
